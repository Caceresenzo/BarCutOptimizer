package dev.caceresenzo.barcutoptimizer.logic.algorithms.impl;
...
import dev.caceresenzo.barcutoptimizer.logic.algorithms.CutAlgorithmException;
...
public class FillingCutAlgorithm implements CutAlgorithm {
	...
	@AlgorithmSetting(key = "xcut-offset")
	private double cutOffsetx = 10.0d;
