...
import dev.caceresenzo.barcutoptimizer.io.export.ExporterCallback;
import dev.caceresenzo.barcutoptimizer.io.export.PdfDataExporter;
...
public class ExportDialog extends JDialog {
	...
	private void openFileSelector() {
		...
		if (directory != null && filename != null) {
			if (!filename.endsWith("." + Defaults.PDF_EXTENSION)) {
				filename += "." + Defaults.PDF_EXTENSION;
			}
